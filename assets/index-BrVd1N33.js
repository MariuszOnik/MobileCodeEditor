import{t as e}from"./rolldown-runtime-DK3Fl9T5.js";import{a as t,c as n,i as r,l as i,n as a,o,r as s,s as c,t as ee}from"./monaco-DKrxE9GP.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})(),self.MonacoEnvironment={getWorker(e,n){return n===`typescript`||n===`javascript`?new r:n===`html`||n===`handlebars`?new s:n===`css`||n===`scss`||n===`less`?new a:n===`json`?new ee:new t}};var l=`
...
`,u=i.typescript;if(u?.typescriptDefaults){let e={target:u.ScriptTarget?.ES2022??99,module:u.ModuleKind?.ESNext??99,allowNonTsExtensions:!0,allowSyntheticDefaultImports:!0,esModuleInterop:!0,checkJs:!0};u.typescriptDefaults.addExtraLib(l,`ts:engine-defs.d.ts`),u.typescriptDefaults.setCompilerOptions(e),u.javascriptDefaults.addExtraLib(l,`ts:engine-defs.d.ts`),u.javascriptDefaults.setCompilerOptions(e)}function te(e,t,r=`typescript`,i=14){return n.create(e,{value:t,language:r,theme:`vs-dark`,fontSize:i,fontFamily:`"Roboto Mono", "Fira Mono", "Courier New", monospace`,fontLigatures:!1,minimap:{enabled:!1},glyphMargin:!1,folding:!1,lineNumbers:`on`,lineNumbersMinChars:3,lineDecorationsWidth:0,scrollBeyondLastLine:!1,scrollBeyondLastColumn:5,automaticLayout:!0,tabSize:2,wordWrap:`off`,scrollbar:{horizontal:`auto`,vertical:`auto`,useShadows:!1},overviewRulerLanes:0,padding:{top:8},renderLineHighlight:`line`,guides:{indentation:!1,bracketPairs:!1,highlightActiveIndentation:!1}})}function ne(e){return e.endsWith(`.ts`)?`typescript`:e.endsWith(`.html`)||e.endsWith(`.htm`)?`html`:e.endsWith(`.css`)?`css`:e.endsWith(`.json`)?`json`:`javascript`}var d=(e,t)=>t.some(t=>e instanceof t),re,ie;function ae(){return re||=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction]}function oe(){return ie||=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey]}var f=new WeakMap,p=new WeakMap,m=new WeakMap;function se(e){let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`success`,i),e.removeEventListener(`error`,a)},i=()=>{t(g(e.result)),r()},a=()=>{n(e.error),r()};e.addEventListener(`success`,i),e.addEventListener(`error`,a)});return m.set(t,e),t}function ce(e){if(f.has(e))return;let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`complete`,i),e.removeEventListener(`error`,a),e.removeEventListener(`abort`,a)},i=()=>{t(),r()},a=()=>{n(e.error||new DOMException(`AbortError`,`AbortError`)),r()};e.addEventListener(`complete`,i),e.addEventListener(`error`,a),e.addEventListener(`abort`,a)});f.set(e,t)}var h={get(e,t,n){if(e instanceof IDBTransaction){if(t===`done`)return f.get(e);if(t===`store`)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return g(e[t])},set(e,t,n){return e[t]=n,!0},has(e,t){return e instanceof IDBTransaction&&(t===`done`||t===`store`)?!0:t in e}};function le(e){h=e(h)}function ue(e){return oe().includes(e)?function(...t){return e.apply(_(this),t),g(this.request)}:function(...t){return g(e.apply(_(this),t))}}function de(e){return typeof e==`function`?ue(e):(e instanceof IDBTransaction&&ce(e),d(e,ae())?new Proxy(e,h):e)}function g(e){if(e instanceof IDBRequest)return se(e);if(p.has(e))return p.get(e);let t=de(e);return t!==e&&(p.set(e,t),m.set(t,e)),t}var _=e=>m.get(e);function fe(e,t,{blocked:n,upgrade:r,blocking:i,terminated:a}={}){let o=indexedDB.open(e,t),s=g(o);return r&&o.addEventListener(`upgradeneeded`,e=>{r(g(o.result),e.oldVersion,e.newVersion,g(o.transaction),e)}),n&&o.addEventListener(`blocked`,e=>n(e.oldVersion,e.newVersion,e)),s.then(e=>{a&&e.addEventListener(`close`,()=>a()),i&&e.addEventListener(`versionchange`,e=>i(e.oldVersion,e.newVersion,e))}).catch(()=>{}),s}var pe=[`get`,`getKey`,`getAll`,`getAllKeys`,`count`],me=[`put`,`add`,`delete`,`clear`],v=new Map;function he(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t==`string`))return;if(v.get(t))return v.get(t);let n=t.replace(/FromIndex$/,``),r=t!==n,i=me.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||pe.includes(n)))return;let a=async function(e,...t){let a=this.transaction(e,i?`readwrite`:`readonly`),o=a.store;return r&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),i&&a.done]))[0]};return v.set(t,a),a}le(e=>({...e,get:(t,n,r)=>he(t,n)||e.get(t,n,r),has:(t,n)=>!!he(t,n)||e.has(t,n)}));var ge=[`continue`,`continuePrimaryKey`,`advance`],_e={},y=new WeakMap,b=new WeakMap,ve={get(e,t){if(!ge.includes(t))return e[t];let n=_e[t];return n||=_e[t]=function(...e){y.set(this,b.get(this)[t](...e))},n}};async function*ye(...e){let t=this;if(t instanceof IDBCursor||(t=await t.openCursor(...e)),!t)return;t=t;let n=new Proxy(t,ve);for(b.set(n,t),m.set(n,_(t));t;)yield n,t=await(y.get(n)||t.continue()),y.delete(n)}function x(e,t){return t===Symbol.asyncIterator&&d(e,[IDBIndex,IDBObjectStore,IDBCursor])||t===`iterate`&&d(e,[IDBIndex,IDBObjectStore])}le(e=>({...e,get(t,n,r){return x(t,n)?ye:e.get(t,n,r)},has(t,n){return x(t,n)||e.has(t,n)}}));var be=e({deleteFile:()=>E,hasNativeFs:()=>Ce,listFiles:()=>D,openNativeFolder:()=>we,readFile:()=>w,writeFile:()=>T}),xe=`mce-fs`,S=`files`,Se=null;async function C(){return Se||=await fe(xe,1,{upgrade(e){e.createObjectStore(S,{keyPath:`path`})}}),Se}async function w(e){return(await(await C()).get(S,e))?.content??null}async function T(e,t){await(await C()).put(S,{path:e,content:t,updatedAt:Date.now()})}async function E(e){await(await C()).delete(S,e)}async function D(){return(await(await C()).getAll(S)).map(e=>e.path).sort()}var O=null;function Ce(){return`showDirectoryPicker`in window}async function we(){if(!Ce())throw Error(`File System Access API not supported`);O=await window.showDirectoryPicker({mode:`readwrite`}),await Te()}async function Te(){if(O)for await(let[e,t]of O.entries())t.kind===`file`&&(e.endsWith(`.ts`)||e.endsWith(`.js`))&&await T(e,await(await t.getFile()).text())}var k=new Map;function A(e,t){return k.has(e)||k.set(e,new Set),k.get(e).add(t),()=>k.get(e)?.delete(t)}function j(e,t){k.get(e)?.forEach(e=>e(t))}var M={FILE_OPEN:`file:open`,FILE_SAVE:`file:save`,FILE_CREATE:`file:create`,FILE_DELETE:`file:delete`,FILE_RENAME:`file:rename`,RUN_START:`run:start`,RUN_STOP:`run:stop`,COMPILE_OK:`compile:ok`,COMPILE_ERR:`compile:error`,PANEL_SWITCH:`panel:switch`};function N(e){return new Promise(t=>{let n=De();n.innerHTML=`
    ...
    `,e.querySelector(`.ft-btn-new`).addEventListener(`click`,()=>this.createFile()),e.querySelector(`.ft-btn-folder`).addEventListener(`click`,()=>this.createFolder()),e.appendChild(this.makeUploadBtn()),this.el.appendChild(e),this.el.insertAdjacentHTML(`beforeend`,`<div class="ft-body"></div>`),this.refresh()}makeUploadBtn(e){let t=document.createElement(`label`);t.className=`ft-btn ft-btn-upload`,t.title=e?`Wgraj plik do „${e}"`:`Wgraj plik z urządzenia`,t.textContent=`📥`;let n=document.createElement(`input`);return n.type=`file`,n.multiple=!0,n.accept=`.js,.ts,.html,.css,.json,.txt,.md,.xml,.csv,.ga`,n.style.display=`none`,n.addEventListener(`change`,async()=>{let t=Array.from(n.files??[]);if(!t.length)return;let r=``;for(let n of t){let t=await n.text(),i=e?`${e}/${n.name}`:n.name;await T(i,t),j(M.FILE_CREATE,i),r=i}n.value=``,await this.refresh(),r&&j(M.FILE_OPEN,r)}),t.appendChild(n),t}renderTree(e,t=0){let n=this.el.querySelector(`.ft-body`);t===0&&(n.innerHTML=``),this.renderNodes(n,e,t)}renderNodes(e,t,n){for(let r of t)if(r.type===`folder`){let t=!this.collapsed.has(r.path),i=document.createElement(`div`);i.className=`ft-folder`,i.setAttribute(`data-folder`,r.path),i.innerHTML=`
        ...
        `;let a=i.querySelector(`.ft-folder-header`),o=this.makeUploadBtn(r.path);o.classList.add(`ft-upload-here`),a.querySelector(`.ft-add-here`).insertAdjacentElement(`afterend`,o),i.querySelector(`.ft-folder-header`).addEventListener(`click`,e=>{let t=e.target;t.classList.contains(`ft-del`)||t.classList.contains(`ft-add-here`)||t.classList.contains(`ft-btn-upload`)||(this.collapsed.has(r.path)?this.collapsed.delete(r.path):this.collapsed.add(r.path),this.refresh())}),i.querySelector(`.ft-add-here`).addEventListener(`click`,e=>{e.stopPropagation(),this.createFile(r.path)}),i.querySelector(`.ft-del`).addEventListener(`click`,async e=>{if(e.stopPropagation(),!await N(`Usuń folder „${r.name}" i wszystkie pliki?`))return;let t=await D();for(let e of t)(e===r.path||e.startsWith(r.path+`/`))&&await E(e);j(M.FILE_DELETE,r.path),await this.refresh()}),e.appendChild(i),t&&r.children?.length&&this.renderNodes(i,r.children,n+1)}else{let t=r.name.split(`.`).pop()??``,i=t===`ts`?`📄`:t===`js`?`📜`:t===`html`||t===`htm`?`🌐`:t===`json`?`📋`:t===`css`?`🎨`:`📝`,a=document.createElement(`div`);a.className=`ft-item`+(r.path===this.activeFile?` active`:``),a.setAttribute(`data-path`,r.path),a.style.paddingLeft=`${8+n*14}px`,a.innerHTML=`
